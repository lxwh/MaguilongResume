$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫马贵龙，是北京一家互联网公司的web前端开发工程师</div>");
	...
	w.load("<li class='writecode'>github:<a href='https://github.com/lxwh' target='_blank'>https://github.com/lxwh</a></li>");
	w.load("</ul>");
	...
	w.load("<li class='writecode'>熟悉jQuery、Zepto等JS库，实现对DOM和BOM的操作</li>");
	w.load("<li class='writecode'>熟练运用Grunt、Git、版本管理工具和Chrome-network抓包工具</li>");
	w.load("<li class='writecode'>了解Node.js、PHP、MySql、Python等后台和服务器端语言</li>");
	w.load("<li class='writecode'>阅读和分析过部分框架源码，如Bootstrap、jQuery，了解小程序开发</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>项目经验</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>No.1 项目名称：<a href='http://10.100.219.77' target='_blank'>ThinkStack存储管理（云方向）</a></li>");
...
c.load("<p><div class='comment writecode'>/**</div>");
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ/微信:2270646605</div>");
	c.load("<div class='comment writecode'>&nbsp;*mobile:13522654025</div>");
